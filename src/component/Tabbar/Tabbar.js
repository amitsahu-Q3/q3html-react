           ...
           <div className="common-heading-bx">
            ...
            <div className='tabbar-main-bx'>
                <div>
                    ...
                    <ul class="tabs">
                        <li class="tab-item">
                            <a class="tab-link active" aria-current="page" href="#">
                                <i>
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_176_1142)">
                ...
                <div>
                <p> Type 2 - Border Bottom</p>
                    <ul class="tabs tabs-border tabs-border-bottom">
                        <li class="tab-item">
                            <a class="tab-link active" aria-current="page" href="#">
                               Home
                            </a>
                ...
                <div>
                <p>  Type2 - Border Top</p>
                    <ul class="tabs tabs-border tabs-border-top">
                        <li class="tab-item">
                            <a class="tab-link active" aria-current="page" href="#">
                               Home
                            </a>
                ...
                <div>
                <p>  Type2 - Border Left</p>
                    <ul class="tabs tabs-border tabs-border-left">
                        <li class="tab-item">
                            <a class="tab-link active" aria-current="page" href="#">
                               Home
                            </a>
                ...
                <div>
                <p>  Type2 - Border Right</p>
                    <ul class="tabs tabs-border tabs-border-right">
                        <li class="tab-item">
                            <a class="tab-link active" aria-current="page" href="#">
                               Home
                            </a>
